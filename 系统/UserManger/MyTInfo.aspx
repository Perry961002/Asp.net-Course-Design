<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyTInfo.aspx.cs" Inherits="TManger_MyTInfo" %>
...
<body>
  ...
  <div class="admindiv">
    <!--内容部分 -->
      ...
      <div class="adminzhong" style="height:727px">
	  <!--中部内容 -->
	  <div class="adminleft">
	  ...
	  <div class="adminright"  style="height: 731px">
	   <!--右边内容 -->
            ...
            <table align="center" border="0" cellpadding="3" cellspacing="1" style="width: 100%">
                ...
                <tr>
                    ...
                    <td align="left" style="width: 228px; height: 24px">
                        <asp:Label ID="lbzhigonghao" runat="server" Text="Label"></asp:Label>
                    </td>
                    <td align="left" rowspan="5" style="color: #000000" class="auto-style1">
         照片：</td>
                    <td align="left" rowspan="4" style="width: 283px" valign="top">
                        <table style="width: 292px; height: 91px">
                            <tr>
                                <td style="width: 100px">
                                    <asp:Image ID="Image1" runat="server" Height="131px" Width="124px" /></td>
                                <td style="width: 100px">
                                    &nbsp;&nbsp;<input id="file1" runat="server" class="inputBox" style="width: 70px; margin-left: 0px; height: 24px;" type="file" /><asp:Label ID="Label2" runat="server" Visible="False" Width="60px" style="margin-left: 0px"></asp:Label>&nbsp;</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="width: 93px; height: 23px">
                            身份证：</td>
                    <td align="left" style="width: 228px; height: 23px">
                        <asp:TextBox ID="zhengjianhaoma" runat="server" Width="120px"></asp:TextBox>
                    ...
                    <td align="left" class="auto-style2">
                            参加工作年月：</td>
                    <td align="left" style="width: 283px; height: 23px">
                        <asp:TextBox ID="gongzuoriqi" runat="server" MaxLength="200" onclick="getDateString(this,oCalendarChs)"
