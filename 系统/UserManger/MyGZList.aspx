<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyGZList.aspx.cs" Inherits="TManger_MyGZList" %>
	    ...
	    <div class="adminrightcon">
		  <table align="center" border="0" cellpadding="3" cellspacing="1" style="width: 100%;">
            <tr>
              ...
              <tr>
                  <td style="height: 24px; background-color: #e8e8e8; text-align: center" width="100%">
                      发放月份：<asp:DropDownList ID="DropDownList1" runat="server">
                          <asp:ListItem Selected="True" Value="0">--所有月份--</asp:ListItem>
