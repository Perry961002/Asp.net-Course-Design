<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyPerformance.aspx.cs" Inherits="UserManger_MyPerformance" %>
                ...
                <td width="50%" style="height: 30px">
                    <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ShowPerformance.aspx?id="+Eval("id") %>'
