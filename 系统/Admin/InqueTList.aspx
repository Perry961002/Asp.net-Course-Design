<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InqueTList.aspx.cs" Inherits="Admin_InqueTList" %>
                ...
                <td width="50%" style="height: 30px">
                    <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <asp:TemplateField HeaderText="添加日期" SortExpression="num">
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "ShowTinfo.aspx?id="+Eval("Userid") %>'
                        ...
                        <asp:TemplateField HeaderText="修改">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyTinfo.aspx?id="+Eval("Userid") %>'
