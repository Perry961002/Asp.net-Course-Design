<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPerformance.aspx.cs" Inherits="Admin_AddPerformance" %>
            ...
            <tr>
              ...
              <tr>
                  <td class="left_title_1" style="width: 122px; height: 30px">
                      奖惩内容：</td>
                  <td align="left" style="width: 621px; height: 30px">
                      <asp:TextBox ID="TextBox1" runat="server" Height="221px" TextMode="MultiLine" Width="592px"></asp:TextBox></td>
              </tr>
              <tr>
