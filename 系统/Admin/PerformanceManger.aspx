<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PerformanceManger.aspx.cs" Inherits="Admin_PerformanceManger" %>
                    ...
                    <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                               <asp:TemplateField HeaderText="员工账号">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="username" runat="server" Text='<%# Bind("zhigonghao") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="奖惩类型">
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                                <ItemTemplate>
                                    <asp:Label ID="TypeName" runat="server" Text='<%# Bind("TypeName") %>' Width="86px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="奖惩薪资">
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                                <ItemTemplate>
                                    <asp:Label ID="PNum" runat="server" Text='<%# Bind("PNum") %>' Width="74px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyPerformance.aspx?id="+Eval("id") %>'
