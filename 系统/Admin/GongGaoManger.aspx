<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GongGaoManger.aspx.cs" Inherits="Admin_GongGaoManger" %>
            ...
            <tr>
                <td width="50%" style="height: 30px">
                    <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        BackColor="White" CellPadding="5" DataKeyNames="GGBH" OnPageIndexChanging="GvInfo_PageIndexChanging"
                        ...
                        <Columns>
                               <asp:TemplateField HeaderText="标题">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="GGBT" runat="server" Text='<%# Bind("GGBT") %>' Width="432px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifGongGao.aspx?id="+Eval("GGBH") %>'
