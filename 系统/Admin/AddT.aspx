<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddT.aspx.cs" Inherits="Admin_AddT" %>
...
<body>
  ...
  <div class="admindiv" style="height: 876px">
    <!--内容部分 -->
      &nbsp;
      <uc1:Top ID="Top1" runat="server" />
      <div class="adminzhong" style="height:730px">
	  <!--中部内容 -->
	  <div class="adminleft">
	  ...
	  <div class="adminright"  style="height: 733px">
	   <!--右边内容 -->
	    ...
	    <div class="adminrightcon">
		  <table align="center" border="0" cellpadding="3" cellspacing="1" style="width: 100%;">
            ...
            <tr>
                      ...
                      <asp:TextBox ID="zhigonghao" runat="server" Width="164px"></asp:TextBox>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="zhigonghao"
     ...
     <td align="left" rowspan="4" style="width: 283px" valign="top">
         <table style="height: 91px; width: 292px;">
             <tr>
                 ...
                 <td style="width: 100px">
                     <asp:TextBox ID="pic" runat="server" CssClass="inputBox" ReadOnly="True" Width="118px"></asp:TextBox>
                     &nbsp;
                     <input id="file1" runat="server" class="inputBox" style="width: 125px" type="file" align="middle" />
                     <asp:Button ID="Button2" runat="server" CausesValidation="False" CssClass="formbutton"
                         Height="22px" OnClick="Button2_Click" Text="上传图片" Width="129px" />
              ...
              <tr>
                  ...
                  <td align="left" style="width: 283px; height: 23px">
                     <input id="file2" runat="server" class="inputBox" style="width: 186px" type="file" align="middle" /><asp:Label ID="Label3" runat="server" Visible="False" Width="85px"></asp:Label>
                      <br />
                     <asp:TextBox ID="pic0" runat="server" CssClass="inputBox" ReadOnly="True" Width="180px"></asp:TextBox>
                     <asp:Button ID="Button3" runat="server" CausesValidation="False" CssClass="formbutton"
                         Height="22px" OnClick="Button3_Click" Text="上传合同" Width="68px" />
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="pic0"
                          ErrorMessage="*" Width="14px"></asp:RequiredFieldValidator>
                     </td>
              </tr>
                    <tr>
                        <td style="width: 93px; height: 23px">
                    ...
                    <tr>
                        <td style="width: 93px; height: 23px">
                            身份证：</td>
                        <td align="left" style="width: 228px; height: 23px">
                            <asp:TextBox ID="zhengjianhaoma" runat="server" Width="167px"></asp:TextBox>
