<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TInfoManger.aspx.cs" Inherits="Admin_TInfoManger" %>
            ...
            <tr>
                <td width="50%" style="height: 30px">
                    <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        BackColor="White" CellPadding="5" DataKeyNames="zhigonghao" OnPageIndexChanging="GvInfo_PageIndexChanging"
                        ...
                        <asp:TemplateField HeaderText="账号">
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Bind("zhigonghao") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="部门">
                            <ItemTemplate>
                                <asp:Label ID="BMXX" runat="server" Text='<%# Bind("BMXX") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="200px" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="添加日期" SortExpression="num">
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "ShowTinfo.aspx?zhigonghao="+Eval("zhigonghao") %>'
                        ...
                        <asp:TemplateField HeaderText="修改">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyTinfo.aspx?zhigonghao="+Eval("zhigonghao") %>'
