<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DDInfoManger.aspx.cs" Inherits="Admin_DDInfoManger" %>
                    ...
                    <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="标题">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="DDBT" runat="server" Text='<%# Bind("DDBT") %>' Width="86px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="添加时间">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="AddTime" runat="server" Text='<%# Bind("DDTime") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                         
                                <asp:TemplateField HeaderText="查看/修改">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyDDInfo.aspx?id="+Eval("id") %>'
                                    Text="查看/修改" Width="96px"></asp:HyperLink>
                            </ItemTemplate>
