            ...
            <tr>
              ...
              <tr>
                  <td align="center" style="height: 30px" width="50%">
                      登录账号：<asp:TextBox ID="txtname" runat="server" Width="138px"></asp:TextBox>登录密码：<asp:TextBox
                          ID="TextBox1" runat="server" TextMode="Password" Width="138px"></asp:TextBox>
                      <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="添加账号" />
                  </td>
              </tr>
            <tr>
                    ...
                    <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="登录账号">
                                <ItemTemplate>
                                    <asp:Label ID="Name" runat="server" Width="179px"><%# Eval("Name") %></asp:Label>
                                </ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="登录密码">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="Pwd"  TextMode="Password"  runat="server" Width="179px">********************</asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
